...
// RequestOption is an option for the requests made by the context.dev API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/context-dot-dev/context-go-sdk/v2#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.context.dev/v1/")
}
